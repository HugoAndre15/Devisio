 ...
 */
final class Version20250719102811 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE invoice (id INT AUTO_INCREMENT NOT NULL, company_id INT NOT NULL, customer_id INT NOT NULL, created_by_id INT NOT NULL, quote_id INT DEFAULT NULL, number VARCHAR(255) NOT NULL, status VARCHAR(50) NOT NULL, subject VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, invoice_date DATE NOT NULL, due_date DATE NOT NULL, subtotal NUMERIC(10, 2) NOT NULL, vat_amount NUMERIC(10, 2) NOT NULL, total NUMERIC(10, 2) NOT NULL, payment_terms LONGTEXT DEFAULT NULL, notes LONGTEXT DEFAULT NULL, sent_at VARCHAR(255) DEFAULT NULL, paid_at VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_9065174496901F54 (number), INDEX IDX_90651744979B1AD6 (company_id), INDEX IDX_906517449395C3F3 (customer_id), INDEX IDX_90651744B03A8386 (created_by_id), UNIQUE INDEX UNIQ_90651744DB805178 (quote_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
